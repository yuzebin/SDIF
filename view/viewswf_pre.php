...
<script type="text/javascript" src="../static/js/view_lib.js"></script>
</head>
...
function Reader()
{
	...
	{
		baidu.swf.create({id:"reader",width:"717",height:"700",ver:"9.0.0",errorMessage:"Please download the newest flash player.",url:"../static/flash/reader.swf",bgColor:"#FFFFFF",wmode:"window",wmode:"transparent",allowfullscreen:"true",vars:{docurl:"../play",docid:"getswfx_pre.php?docid=<?php echo $docid;?>&totalpages=<?php echo $totalpages;?>",fpn:"1",npn:"1"}},D);
		A(D)
	};
